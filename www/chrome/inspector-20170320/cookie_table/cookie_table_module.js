...
_findSelectedCookie(selectionCookies,cookies){var current=selectionCookies.current;var foundCurrent=cookies.find(cookie=>this._isSameCookie(cookie,current));if(foundCurrent)
