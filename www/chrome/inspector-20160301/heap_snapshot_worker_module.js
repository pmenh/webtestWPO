...
return null;merged.begin=first.begin;merged.end=Math.max(first.end,second.end);return merged;}};self.WebInspector={};WebInspector.UIString=function(string,vararg)
